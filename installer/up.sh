...
frontend ssl
    ...
    use_backend GRUP_GEOVPN if up-to
    use_backend GEOVPN if chk-02_up chk-02_ws 
    use_backend GEOVPN if { path_reg -i ^\/(.*) }
    use_backend BOT_GEOVPN if this_payload
    default_backend CHANNEL_GEOVPN
